...
public abstract class Product implements Item {
  ...
  Product(String name) {
    ...
    /**
     * increments the classes production number. Find Bugs says that this is improper use of static Integers
     * but when i declare it as a int the counter doesn't increase. And I also don't know a work around
     * other then declaring it static and as a Integer which was specified in the oracle doc.
     */
  ...
  /**takes input as int and stores it into the product class
  *in the int variable currentProductionNumber
  */
